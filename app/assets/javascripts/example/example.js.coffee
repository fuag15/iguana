...
((example, $) ->
  ...
  example.get_context = ->
    ...
    window.iguana.example.renderer.setSize window.iguana.example.width, 
                                                                                  window.iguana.example.height
  ...
  example.add_sphere = ->
    ...
    sphere = new window.THREE.Mesh new window.THREE.SphereGeometry( radius, segments, rings), 
                                                                       sphereMaterial
  ...
  example.render = ->
    window.iguana.example.render window.iguana.example.scene, 
                                                                window.iguana.example.camera
